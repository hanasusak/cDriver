...
bcgr <- function(sample.mutations, genes=NULL, Variant_Classification=NULL, Hugo_Symbol=NULL, Tumor_Sample_Barcode=NULL, CCF=NULL){
    ...
    if (is.null(genes)){
        message('As you did not provide list of genes which were sequenced, union of  all protein coding genes (all.genes.length) and your genes is taken')
...
bcgr.lawrence <- function(sample.mutations, genes=NULL, lengthGenes=NULL, Variant_Classification=NULL, Hugo_Symbol=NULL, Tumor_Sample_Barcode=NULL, CCF=NULL){
    ...
    if (is.null(genes)){
        message('As you did not provide list of genes which were sequenced, union of  all protein coding genes (all.genes.lengths) and your genes is taken')
